...
this.tweens.add({
  ...
  // if (this.table1.contains(this.player.x, this.player.y)) {
  //   window.table++;
  //   console.log('table1',window.table)
  //   this.hamper.setVisible(true)
  //   this.table.setVisible(false)
  // }
  
  // if (this.tableArea2.contains(this.player.x, this.player.y)) {
  //   console.log('tableArea2')
  //   window.table++;
  //   this.hamper2.setVisible(true)
  // }
  // if (this.tableArea3.contains(this.player.x, this.player.y)) {
  //   console.log('tableArea3')
  //   window.table++;
  //   this.hamper3.setVisible(true)
  // }
  // if (this.tableArea4.contains(this.player.x, this.player.y)) {
  //   console.log('tableArea4')
  //   window.table++;
  //   this.hamper4.setVisible(true)
  // }
  // if (this.tableArea5.contains(this.player.x, this.player.y)) {
  //   console.log('tableArea5')
  //   window.table++;
  //   this.hamper5.setVisible(true)
  // }
...
// collectHamper(player, hamper){
//   console.log("Player collect hamper");
